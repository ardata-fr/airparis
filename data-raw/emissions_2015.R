...
data_emissions_epci <- read_emissions(geo = "epci")
data_emissions_departement <- read_emissions(geo = "departement")
data_emissions_region <- read_emissions(geo = "region")

names_col_epci <- colnames(data_emissions_epci)
names_col_departement <- colnames(data_emissions_departement)
names_col_region <- colnames(data_emissions_region)
names(data_emissions_epci) <- gsub("_?kg$", "", names_col_epci)
names(data_emissions_departement) <- gsub("_?kg$", "", names_col_departement)
names(data_emissions_region) <- gsub("_?kg$", "", names_col_region)

usethis::use_data(data_emissions_epci, overwrite = TRUE)
usethis::use_data(data_emissions_departement, overwrite = TRUE)
usethis::use_data(data_emissions_region, overwrite = TRUE)
